...
public interface Location extends ILocationStandardValues {
    ...
    /**
     * checks if there is enough space available for a user. This is for old implementation.
     * Kept until ClusterManager is implemented. For now, only used by tests, because space usage of a user is tracked nowhere.
     *
     * @param _user user which wants to store a file
     * @param _fileSize size that user asks for
     * @return success
     */
    ...
    /**
     * maintenance state of a storagecell, should be checked before using
     *
     * @return true if storagecell should not be used
     */
