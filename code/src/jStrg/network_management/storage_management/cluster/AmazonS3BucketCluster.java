...
public class AmazonS3BucketCluster extends Cluster {
    ...
    /**
     * register new bucket to cluster
     * @param _config configuration for the Location (ILocationCofig)
     * @return the registered storagecell object
     */
