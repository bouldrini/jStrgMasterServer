...
@Entity
/**
 * baseclass for all types of clusters
 */
public abstract class Cluster extends DatabaseEntity {
    ...
    /**
     * checks if a cluster got enough space for a file
     * @param _file_size size of the file
     * @return true if enough space is left false if there is not enough space left
     */
    ...
    /**
     * unregisters storage cell (could be a bucket or a server)
     * @param _cell the storage_cell you want to unregister
     */
 ...
 /*   public boolean upload(File _file){
    ...
    /**
     * returns the application that belongs to that cluster
     * @return Application object the cluster belongs to
     */
