...
/**
 * Baseclass for Uploads from master to subserver
 */
public class InternalUpload {
    ...
    public InternalUpload(Socket _socket, String _file_name, String _file_path, long _file_size, String _transaction_id) throws GeneralSecurityException, IOException {
        m_socket = _socket;
