...
public class DownloadFileRequestInternalAnswer extends InternalAnswer {
    public DownloadFileRequestInternalAnswer(Application _application, String _server_answer) throws GeneralSecurityException, IOException {
